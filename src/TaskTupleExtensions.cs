...
public static class TaskTupleExtensions
{
    ...
    public readonly struct TupleTaskAwaiter<T1, T2>((Task<T1>, Task<T2>) tasks) : INotifyCompletion
    {
        readonly TaskAwaiter whenAllAwaiter = Task.WhenAll(tasks.Item1, tasks.Item2).GetAwaiter();
    ...
    public readonly struct TupleConfiguredTaskAwaitable<T1, T2>(
        (Task<T1>, Task<T2>) tasks,
        bool continueOnCapturedContext)
    {
        public Awaiter GetAwaiter() => new(tasks, continueOnCapturedContext);

        public readonly struct Awaiter((Task<T1>, Task<T2>) tasks, bool continueOnCapturedContext) : INotifyCompletion
        {
            readonly ConfiguredTaskAwaitable.ConfiguredTaskAwaiter whenAllAwaiter = Task
    ...
    public readonly struct TupleTaskAwaiter<T1, T2, T3>((Task<T1>, Task<T2>, Task<T3>) tasks) : INotifyCompletion
    {
        readonly TaskAwaiter whenAllAwaiter = Task.WhenAll(tasks.Item1, tasks.Item2, tasks.Item3).GetAwaiter();
    ...
    public readonly struct TupleConfiguredTaskAwaitable<T1, T2, T3>(
        (Task<T1>, Task<T2>, Task<T3>) tasks,
        bool continueOnCapturedContext)
    {
        public Awaiter GetAwaiter() => new(tasks, continueOnCapturedContext);

        public readonly struct Awaiter((Task<T1>, Task<T2>, Task<T3>) tasks, bool continueOnCapturedContext)
            : INotifyCompletion
        {
            readonly ConfiguredTaskAwaitable.ConfiguredTaskAwaiter whenAllAwaiter = Task
                .WhenAll(tasks.Item1, tasks.Item2, tasks.Item3).ConfigureAwait(continueOnCapturedContext)
                .GetAwaiter();
    ...
    public readonly struct TupleTaskAwaiter<T1, T2, T3, T4>((Task<T1>, Task<T2>, Task<T3>, Task<T4>) tasks)
        : INotifyCompletion
    {
        ...
        bool continueOnCapturedContext)
    {
        ...
        public readonly struct Awaiter((Task<T1>, Task<T2>, Task<T3>, Task<T4>) tasks, bool continueOnCapturedContext)
            : INotifyCompletion
        {
            readonly ConfiguredTaskAwaitable.ConfiguredTaskAwaiter whenAllAwaiter = Task
    ...
    public readonly struct TupleTaskAwaiter<T1, T2, T3, T4, T5>(
        (Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>) tasks) : INotifyCompletion
    {
        readonly TaskAwaiter whenAllAwaiter =
    ...
    public readonly struct TupleTaskAwaiter<T1, T2, T3, T4, T5, T6>(
        (Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>) tasks)
        : INotifyCompletion
    {
        readonly TaskAwaiter whenAllAwaiter = Task
    ...
    public readonly struct TupleTaskAwaiter<T1, T2, T3, T4, T5, T6, T7>(
        (Task<T1>, Task<T2>, Task<T3>, Task<T4>, Task<T5>, Task<T6>, Task<T7>) tasks)
        : INotifyCompletion
    {
        readonly TaskAwaiter whenAllAwaiter = Task.WhenAll(tasks.Item1, tasks.Item2, tasks.Item3, tasks.Item4,
            tasks.Item5, tasks.Item6,
    ...
    public readonly struct TupleTaskAwaiter<T1, T2, T3, T4, T5, T6, T7, T8>(
    ...
    public readonly struct TupleTaskAwaiter<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
    ...
    public readonly struct TupleTaskAwaiter<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
        ...
        bool continueOnCapturedContext)
    {
            ...
            : INotifyCompletion
        {
            readonly ConfiguredTaskAwaitable.ConfiguredTaskAwaiter whenAllAwaiter = Task
                .WhenAll(tasks.Item1, tasks.Item2, tasks.Item3, tasks.Item4, tasks.Item5, tasks.Item6, tasks.Item7,
                    tasks.Item8, tasks.Item9, tasks.Item10)
                .ConfigureAwait(continueOnCapturedContext)
                .GetAwaiter();
